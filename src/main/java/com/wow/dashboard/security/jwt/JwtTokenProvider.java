package com.wow.dashboard.security.jwt;
...
public class JwtTokenProvider {
    ...
    public JwtTokenProvider(@Value("${acore.security.jwt.secret}") String secret,
                            @Value("${acore.security.jwt.expiration-ms:3600000}") long expirationMs) {
